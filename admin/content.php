            ...
            <div class="lits-group list-group-flush">
                <div class="list-group-item">
                    ...
                    <div class="list-group-item-body">
                        ...
                        <p class="card-subtitle text-muted mb-1"> Progress in 74% - Last update
                            1d </p>
                ...
                <div class="list-group-item">
                    ...
                    <div class="list-group-item-body">
                        ...
                        <p class="card-subtitle text-muted mb-1"> Progress in 22% - Last update
                            2h </p>
                        <div class="progress progress-xs bg-transparent">
                ...
                <div class="list-group-item">
                    ...
                    <div class="list-group-item-body">
                        ...
                        <p class="card-subtitle text-muted mb-1"> Progress in 99% - Last update
                            2d </p>
                        <div class="progress progress-xs bg-transparent">
                ...
                <div class="list-group-item">
                    ...
                    <div class="list-group-item-body">
                        ...
                        <p class="card-subtitle text-muted mb-1"> Progress in 35% - Last update
                            4h </p>
                        <div class="progress progress-xs bg-transparent">
                ...
                <div class="list-group-item">
                    ...
                    <div class="list-group-item-body">
                        ...
                        <p class="card-subtitle text-muted mb-1"> Progress in 32% - Last update
                            1d </p>
                        <div class="progress progress-xs bg-transparent">
                            <div class="progress-bar bg-teal" role="progressbar"
                ...
                <div class="list-group-item">
                    ...
                    <div class="list-group-item-body">
                        ...
                        <p class="card-subtitle text-muted mb-1"> Progress in 93% - Last update
                            8h </p>
                        <div class="progress progress-xs bg-transparent">
                ...
                <div class="todo-list">
                    ...
                    <div class="todo">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="todo1">Eat corn on the
                                cob</label>
                        </div>
                    </div>
                    <div class="todo">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="todo2"
                                checked> <label class="custom-control-label" for="todo2">Mix up
                    ...
                    <div class="todo">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="todo3">Have a
                                barbecue</label>
                        </div>
                    </div>
                    <div class="todo">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="todo4">Ride a roller
                                coaster — <span class="text-red small">Overdue in 3
                                    days</span></label>
                        </div>
                    </div>
                    ...
                    <div class="todo">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="todo5">Bring a blanket and
                                lie on the grass at an outdoor concert</label>
                        </div>
                    </div>
                    <div class="todo">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="todo6">
                            <label class="custom-control-label" for="todo6">Collect seashells at
                                the beach</label>
                        </div>
                    </div>
                    <div class="todo">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="todo7">Swim in a
                                lake</label>
                        </div>
                    </div>
                    <div class="todo">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="todo8">Get enough
                                sleep!</label>
                        </div>
                    </div>
                </div>
